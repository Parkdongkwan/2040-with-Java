...
/**
 * 
 * This class writes and reads the Record.txt files. And compute the highest score and userName
 * @author ParkDongKwan
 */
public class RecordHighestScore {
	 ...
	 * If the file is empty, it will just write current user name and score in text files.
	 * If the file is not empty, it reads the score and user name from each of it's text files and store it in arraList.
	 * If the userName is same and the score obtained from text file is less than current score, it will over write the user name and score in text files. 
	 * If the userName is same and  score obtained from text file is higher than current score, it wont write anything and the text file will remain as it is.
	 */
